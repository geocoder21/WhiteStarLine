...
Docstrings were included within the code to increase usability for other viewers of the code, written in line with PEP 257 (Goodger, Jun 2001).  A linter was then used in the IDE to ensure that the code was compliant with PEP 8 (Van Rossum et al, Aug 2013).  Additional in-line comments were included where necessary, and the majority of tests commented out to reduce processing time.  Finally the Apache 2.0 license was selected and a README file created.
