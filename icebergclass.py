...
class Iceberg():
    """Icebergs have coordinates (1m pixel square), height in m, mass if kg,
    and volume in m3. Those less than 36mil kg mass can be pulled by an
    iceberg-towing tug"""
